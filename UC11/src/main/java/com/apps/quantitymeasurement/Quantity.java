...
public class Quantity<U extends IMeasurable> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1 litre equals 1000 ml? " + volumeInLitres.equals(volumeInMl));

        Quantity<VolumeUnit> volumeInGallons = new Quantity<>(1.0, VolumeUnit.GALLON);
        System.out.println("1 gallon equals ~3.78 litres? " + volumeInGallons.equals(new Quantity<>(3.78541, VolumeUnit.LITRE)));
