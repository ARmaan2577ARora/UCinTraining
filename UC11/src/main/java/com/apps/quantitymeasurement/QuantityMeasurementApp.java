...
public class QuantityMeasurementApp {
    ...
    public static void main(String[] args) {
        ...
        demonstrateEquality(vol1, vol2);

        Quantity<VolumeUnit> vol3 = new Quantity<>(1.0, VolumeUnit.GALLON);
        demonstrateEquality(vol1, vol3); // Should be false or close depending on value

        demonstrateConversion(vol1, VolumeUnit.MILLILITRE);
        demonstrateConversion(vol3, VolumeUnit.LITRE);

        demonstrateAddition(vol1, vol2, VolumeUnit.LITRE);
        demonstrateAddition(vol1, vol3, VolumeUnit.MILLILITRE);
    }
